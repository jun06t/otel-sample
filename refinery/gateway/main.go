...
import (
	...
	pb "github.com/jun06t/otel-sample/refinery/proto"
	"github.com/jun06t/otel-sample/refinery/telemetry"
)

var tracer = otel.Tracer("github.com/jun06t/otel-sample/refinery/gateway")
...
func main() {
	...
	_, cleanup, err := telemetry.NewTracerProvider(context.TODO(), otelAddr, "gateway")
	if err != nil {
		log.Fatal(err)
